...
export default class TestPage extends React.Component {
    ...
    s_choose_role() {
        ...
        this.setState({
            step: "role-pick",
            statusMessage: "Choose your destiny!"
        });
    }
    ...
    s_you_are_it(role) {
        ...
        if (role == "first") {
            ...
            this.setState({
                step: "opponents-turn",
                statusMessage: "Enemy is trying to not lose..."
            });
        }
        this.state.socket.on("your_turn", () => this.s_your_turn());
        this.state.socket.on("meme_accepted", data =>
    ...
    s_your_turn() {
        ...
        this.setState({
            step: "my-turn",
            statusMessage: "Your turn! Destroy them!"
        });
    }
    ...
    btnRole(role) {
        ...
        this.setState({
            step: "wait4game",
            statusMessage: "Waiting for that slowpoke to join.."
        });
        this.state.socket.emit("iwannabetracer", role);
        this.state.socket.once("iamalreadytracer", () =>
            this.s_iamalreadytracer()
        );
                ...
                <section className="content">
                    <div id="game">
                        <GameBoard
                            ...
                            onCellClick={(i, j) => this.cellClicked(i, j)}
                        />
